Logs Onix Client scripting logs to the VS console, use ```lua importLib("OnixClientVSLogger")``` in your code to import the library, and use ```lua vs.log()``` to log stuff.
